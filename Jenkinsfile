pipeline {
  ...
  environment {
        ...
        GIT_REPOSITORY_URL = 'https://github.com/jinhyung99/fast'
        ...
        AWS_ECR_URI = '278934099200.dkr.ecr.ap-northeast-2.amazonaws.com'
    ...
    stages {
        ...
        stage('4.Push to ECR') {
            steps {
              // aws credential 플러그인을 설치해서 사용할 수 있는 함수, aws configure과 비슷하다.
        ...
        stage('5.EKS manifest file update') {
            steps {
                ...
                script {
                    ...
                    sed -i 's@${AWS_ECR_URI}/${AWS_ECR_IMAGE_NAME}:.*@${AWS_ECR_URI}/${AWS_ECR_IMAGE_NAME}:${BUILD_NUMBER}@g' fast.yml
                    git add .
                    git branch -M main
